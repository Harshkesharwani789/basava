...
//         "https://basavamart.in/api/order/addorder",
//         {
//           items: orderItem,
//           address: address,
//           type: paymentType,
...
//     const token = localStorage.getItem("token");
//     const response = await axios.get("https://basavamart.in/api/cart/getCart", {
//       headers: { Authorization: `Bearer ${token}` },
//     });
...
const apiClient = axios.create({
  baseURL: "https://basavamart.in/api",
  timeout: 5000,
});
                    ...
                    <ListItem alignItems="flex-start" sx={{ py: 2 }}>
                      ...
                      >
                        <CardMedia
                          ...
                          image={`https://basavamart.in${item.productImg}`}
                          alt={item.productName}
                        />
                        <CardContent sx={{ flex: 1 }}>
                          <Typography variant="subtitle1">
