...
const Banner = () => {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://basavamart.in/api/testimonials/deleteBanner/${id}`);
    ...
    try {
      if (editBanner) {
        ...
        const response = await axios.put(
          `https://basavamart.in/api/testimonials/editBanner/${editBanner._id}`,
          data,
        ...
        const response = await axios.post(
          "https://basavamart.in/api/testimonials/addBanner",
          data,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
