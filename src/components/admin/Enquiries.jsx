...
const Enquiries = () => {
  ...
  const fetchEnquiries = async () => {
    try {
      const res = await axios.get("https://basavamart.in/api/order/getenquiry");
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://basavamart.in/api/order/deleteenquiry/${id}`);
  ...
  const handleUpdateStatus = async () => {
    try {
      await axios.put(
        `https://basavamart.in/api/order/updateenquiry/${selectedEnquiry._id}`,
        {
          status,
        }
      );
